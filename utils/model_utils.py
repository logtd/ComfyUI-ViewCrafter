...
from ..modules.lvdm.modules.encoders.resampler import Resampler
...
def load_viewcrafter_dict(state_dict: dict):
...
class DynamiCrafterBase(supported_models_base.BASE):
    ...
    def clip_target(self):
        return supported_models_base.ClipTarget(sd1_clip.SD2Tokenizer, sd1_clip.SD2ClipModel)
